...
public class PiocheCartesCitadelles {
    ...
    public void implementerCartesCitadelles() {
        ...
        cc[60] = new Cimitière(61,CouleurCarteCitadelles.VIOLET, "Cimitière", 5 );
        cc[61] = new Bibliothèque(62,CouleurCarteCitadelles.VIOLET, "Bibliothèque", 6 );
        cc[62] = new EcoleDeMagie(63,CouleurCarteCitadelles.VIOLET, "École de magie", 6 );
        cc[63] = new Université(64,CouleurCarteCitadelles.VIOLET, "Université", 8 );
        cc[64] = new Dracepert(65,CouleurCarteCitadelles.VIOLET, "Dracopert", 8 );
